...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-lg bg-white p-8 rounded-lg shadow-md">
        ...
        <form action="/updateVoyage/{{$voyage->id}}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <button type="submit" class="w-full bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700">Modifier</button>
        </form>
